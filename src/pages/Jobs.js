      ...
      <div className="modalContainer">
        ...
        >
          <Box sx={style.boxStyle}>
            <Typography id="modal-modal-title" variant="h6" component="h2" sx={style.headerStyle}>
                Applicants for this job
                <CloseOutlinedIcon onClick={handleClose}/>
            </Typography>
            <Typography id="modal-modal-title" variant="h6" component="h4" sx={{fontSize: 15, 
              borderTop: "1px solid #4D618E", paddingTop: 1, paddingBottom: 2}}>
                  ...
                  <Box sx={style.allCandidates}>
                    <Box sx={style.candidateContainer}>
                      <Typography sx={style.candidateLogo}>
                          <Typography sx={style.candidateLogoName}>{candidate?.name[0]}</Typography>
                      </Typography>
                      <Box sx={style.nameContainer}>
                        <Typography variant="h6" component="h5" sx={style.nameHeading}>{candidate.name} </Typography>
                        <Typography sx={style.email}>{candidate.email}</Typography>
                      </Box>
                    </Box>
                    <Box sx={style.skillContainer}>
                        <Typography variant="h6" component="h5" sx={style.skills}>Skills</Typography>
                        <Typography sx={style.candidateSkill}>{candidate.skills}</Typography>
                    </Box>
                  </Box>
                );
              })}
